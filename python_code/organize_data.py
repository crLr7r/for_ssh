...
if model_name == "Diamond":
    ...
    with open(f"{ORGANIZED_DIR}/Eigenvalue/{model.filename}.txt", "w") as f:
    ...
    with open(f"{ORGANIZED_DIR}/Corner_states_data/{model.filename}(state#{cstate}).txt", "w") as f:
    ...
    with open(f"{ORGANIZED_DIR}/2D_density/{model.filename}(state#{cstate}).txt", "w") as f:
...
if model_name == "Ribbon":
    ...
    with open(f"{ORGANIZED_DIR}/Ribbon_band_gap/{model.filename}.txt", "w") as f:
